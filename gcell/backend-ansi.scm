(define-module (gcell backend-ansi)
  ...
  #:use-module ((gcell render) #:select (image-cmd->fallback-cmds))
  #:use-module ((gcell image)  #:select (image-bytes image-registered?))
  #:use-module ((gcell term types) #:prefix t:)
  #:use-module ((gcell term ops) #:prefix t:)
  #:use-module ((gcell term write) #:prefix t:)
  #:use-module ((gcell term render) #:prefix t:)
